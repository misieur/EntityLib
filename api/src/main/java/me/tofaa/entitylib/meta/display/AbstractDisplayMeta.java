...
public abstract class AbstractDisplayMeta extends EntityMeta {
    ...
    public byte maxOffset = (byte) (isVersion(ServerVersion.V_1_20_2, VersionComparison.NEWER_THAN_OR_EQUALS) ? OFFSET + 15 : OFFSET + 14);

    public AbstractDisplayMeta(int entityId, Metadata metadata, ServerVersion serverVersion) {
